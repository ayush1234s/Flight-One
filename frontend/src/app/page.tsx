      ...
      <div className="max-w-7xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-400 text-lg leading-relaxed">
            Flight One is a unified flight travel assistant designed to simplify
            the entire air-travel journey. From discovering flights to retrieving
            tickets, tracking live flights, planning routes, and arranging
            last-mile transport — everything is available in one secure platform.
          </p>
